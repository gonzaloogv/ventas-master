                    ...
                    <div class="row">
                        <nav class="navbar navbar-expand-lg narbar-light">
                            ...
                            <div id="mainNav" class="collapse navbar-collapse tm-bg-white">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-2">Destinos principales</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-3">Lugares recomendados</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-4">Contactanos</a>
                                </li>
                            </ul>
                        </div>                            
                    </nav>
                ...
                <div class="tm-container-outer tm-banner-bg">
                    <div class="container">
                        ...
                        <div class="row tm-banner-row tm-banner-row-header">
                            <div class="col-xs-12">
                                <div class="tm-banner-header">
                                    <h1 class="text-uppercase tm-banner-title">Bienvenido a los mellis</h1>
                                    <img src="img/dots-3.png" alt="Dots">
                                    <p class="tm-banner-subtitle">Te ayudamos a elegir el mejor viaje.</p>
                        ...
                        <div class="row tm-banner-row" id="tm-section-search">
                            ...
                            <form action="index.html" method="get" class="tm-search-form tm-section-pad-2" onsubmit="prevent(event)">
                                <div class="form-row tm-search-form-row">  
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                        <label for="inputCity">Destino</label>
                                        <input name="destination" type="text" class="form-control" id="inputCity" placeholder="Escriba su destino...">
                                    </div>                              
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                        <label for="inputCity">Nombre</label>
                                        <input name="nombre" type="name" class="form-control" id="inputCity" placeholder="Escriba su nombre...">
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                        <label for="inputCity">DNI</label>
                                        <input name="dni" type="text" class="form-control" id="inputCity" placeholder="Escriba su DNI...">
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                        <label for="inputCity">Apellido</label>
                                        <input name="apellido" type="name" class="form-control" id="inputCity" placeholder="Escriba su apellido...">
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                        <label for="inputCity">Numero de contacto</label>
                                        <input name="n_contacto" type="number" required class="form-control" id="inputCity" placeholder="Escriba su numero de contacto..">
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-1" name="pasajes">                                    
                                        <div class="form-group tm-form-group tm-form-group-pad tm-form-group-2">
                                            <label for="inputRoom" name="pasajes">Cantidad de pasajes</label>
                                            <select name="pasajes" class="form-control tm-select" id="inputRoom">
                                                <option value="1" selected>1 Pasaje</option>
                                                <option value="2">2 Pasajes</option>
                                                <option value="3">3 Pasajes</option>
                                                <option value="4">4 Pasajes</option>
                                                <option value="5">5 Pasajes</option>
                                                <option value="6">6 Pasajes</option>
                                                <option value="7">7 Pasajes</option>
                                                <option value="8">8 Pasajes</option>
                                                <option value="9">9 Pasajes</option>
                                                <option value="10">10 Pasajes</option>
                                            </select>                                        
                                        </div>
                                        <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3" name="asiento">                                       
                                            <label for="inputAdult" name="colectivo">colectivo</label>     
                                            <select name="colectivo" class="form-control tm-select" id="inputAdult">
                                        ...
                                        <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                            ...
                                            <label for="inputChildren" name="asiento">asiento</label>                                            
                                            <select name="asiento" class="form-control tm-select" id="inputChildren">
                                ...
                                <div class="form-row tm-search-form-row">
                                    ...
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                        <label for="inputCheckIn">Fecha de inicio</label>
                                        <input name="checkin" type="date" class="form-control" id="inputCheckIn" placeholder="Fecha de inicio">
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                        <label for="inputCheckOut">Fecha de salida</label>
                                        <input name="checkout" type="date" class="form-control" id="inputCheckOut" placeholder="Fecha de salida">
                                    </div>
                                    <form class="form-group tm-form-group tm-form-group-pad tm-form-group-1" onsubmit="prevent(event)">
                                        <button name="enviar" type="submit" class="btn btn-primary tm-btn tm-btn-search text-uppercase">Pagar</button>
                                    </form>
                                </div>                              
                            </form>                             
                            <?php   include("ingreso-info.php"); 
                            ?>
                        </div> <!-- row -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 mx-auto tm-about-text-wrap text-center">                        
                            <h2 class="text-uppercase mb-4">Tu <strong>viaje</strong> es nuestra prioridad</h2>
                            <p class="mb-4">¡No sueñes tu vida, vive tus sueños con Viajes Experiencia Única! Contáctanos hoy y comienza a planificar la aventura de tu vida. Tu próxima escapada está a solo un clic de distancia. ¡Viaja con nosotros y haz cada momento inolvidable! 🌴🌍✈️</p>
                            <a href="#" class="text-uppercase btn-primary tm-btn">Continuar explorando</a>                              
                        </div>
                    </div>
                </div>            
            </section>
            ...
            <div class="tm-container-outer" id="tm-section-2">
                <section class="tm-slideshow-section">
                    ...
                    <div class="tm-slideshow-description tm-bg-primary">
                        <h2 class="">Lugares mas visitados de europa</h2>
                        <p>Europa, un continente lleno de historia, cultura y diversidad, cautiva a los viajeros con su encanto inigualable. Desde los majestuosos Alpes hasta las playas bañadas por el Mediterráneo, cada rincón de Europa ofrece una experiencia única.</p>
                        <a href="#" class="text-uppercase tm-btn tm-btn-white tm-btn-white-primary">Continuar leyendo</a>
                    </div>
                </section>
                <section class="clearfix tm-slideshow-section tm-slideshow-section-reverse">
                    ...
                    <div class="tm-slideshow-description tm-slideshow-description-left tm-bg-highlight">
                        <h2 class="">Lugares mas visitados de Asia</h2>
                        <p>Asia, el continente más extenso y diverso del mundo, deslumbra con su rica mezcla de culturas, paisajes asombrosos y tradiciones milenarias. Desde las bulliciosas metrópolis de Tokio y Seúl hasta los antiguos templos de Angkor Wat en Camboya, Asia ofrece una paleta variada de experiencias.</p>
                        <a href="#" class="text-uppercase tm-btn tm-btn-white tm-btn-white-highlight">Continuar leyendo</a>
                    </div>                        
                ...
                <section class="tm-slideshow-section">
                    ...
                    <div class="tm-slideshow-description tm-bg-primary">
                        <h2 class="">Lugares mas famosos de America</h2>
            ...
            <div class="tm-container-outer" id="tm-section-3">
                ...
                <div class="tab-content clearfix">
                    ...
                    <div class="tab-pane fade" id="7a">
                        ...
                        <a href="#" class="text-uppercase btn-primary tm-btn mx-auto tm-d-table">Mostrar mas</a>
                    </div> <!-- tab-pane -->
                </div>
            </div>
